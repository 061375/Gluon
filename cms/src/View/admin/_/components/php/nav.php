<nav class="hide">
    ...
    <ul>
        <li><a href="<?php echo CURRENT_URL; ?>admin">Dashboard <span title="Dashboard">F</span></a></li>
        <li><a href="<?php echo CURRENT_URL; ?>admin/pages">Pages  <span title="Pages">C</span></a></li>
